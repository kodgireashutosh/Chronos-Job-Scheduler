...
import { Clock, Calendar, Server, CheckCircle, AlertTriangle, Activity} from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-end justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button className="h-9 text-xs bg-blue-600 hover:bg-blue-700">
            Refresh Data
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-slate-900">Job Throughput</h3>
